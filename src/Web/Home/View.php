...
class View
{
    static function Show()
    {
		...
		// Footer
		$h .= Footer::Html(['bg' => '/media/home/lokal.jpg','img' => '/media/img/logo.png', 'name' => 'Borgeros', 'city' => '00-100 Warsaw', 'address' => 'ul. Platynowa 36', 'days' => 'Pn - Nd','hours' => '12:00 - 23:00', 'contact' => 'Contact', 'mobile' => '+48 100 100 100', 'email' => 'email@email.email', 'social' => 'Social', 'tw' => 'twitter.com/@burgeros', 'fb' => 'fb.com/@burgeros', 'in' => 'instagram.com/@burgeros']);
